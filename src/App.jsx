...
/* WHAT HAPPENS */
.what-happens { background: var(--surface2); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 14px 16px; margin-bottom: 20px; }
.what-title { font-size: 10px; font-weight: 500; letter-spacing: 1px; text-transform: uppercase; color: var(--text-3); margin-bottom: 10px; }
.what-steps { display: flex; flex-direction: column; gap: 8px; }
.what-step { display: flex; align-items: flex-start; gap: 10px; font-size: 11px; color: var(--text-2); line-height: 1.5; }
.what-step em { color: var(--accent); font-style: normal; }
.what-num { min-width: 18px; height: 18px; background: var(--accent-light); border: 1px solid var(--accent-border); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 9px; font-weight: 700; color: var(--accent); flex-shrink: 0; margin-top: 1px; }

.modal-fields { display: grid; grid-template-columns: 1fr 1fr; gap: 14px; margin-bottom: 16px; }
.modal-fields .field-full { grid-column: 1 / -1; }
.modal-fields .field-label { font-size: 10px; letter-spacing: 0.8px; margin-bottom: 5px; display: flex; align-items: center; gap: 6px; }
.required-star { color: var(--red); font-size: 11px; }
.optional-tag { font-size: 8px; color: var(--text-3); background: var(--surface); border: 1px solid var(--border); border-radius: 3px; padding: 1px 5px; text-transform: lowercase; }
.help-link { color: var(--blue); text-decoration: none; font-size: 9px; margin-left: auto; opacity: 0.7; transition: opacity 0.15s; }
.help-link:hover { opacity: 1; }
.remember-label { display: flex; align-items: center; gap: 8px; font-size: 11px; color: var(--text-3); cursor: pointer; margin-bottom: 16px; }
...
.btn-testrail { display: inline-flex; align-items: center; gap: 8px; background: var(--accent); color: #0e0e0e; border: none; border-radius: var(--radius-sm); padding: 10px 22px; font-family: var(--display); font-weight: 700; font-size: 13px; cursor: pointer; transition: opacity 0.15s; }
.btn-testrail:hover { opacity: 0.88; }
...
/* SPINNERS */
.spinner { width: 13px; height: 13px; border: 2px solid rgba(0,0,0,0.2); border-top-color: #0e0e0e; border-radius: 50%; animation: spin 0.6s linear infinite; display: inline-block; }
...
@media (max-width: 600px) {
  ...
  .modal-fields .field-full { grid-column: 1; }
